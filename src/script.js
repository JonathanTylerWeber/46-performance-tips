...
const shaderMaterial = new THREE.ShaderMaterial({
  ...
  vertexShader: `
				...
				// can use define instead of uniform to optimize if value doesnt change
				// can also add defines above, dont change
        ...
        void main()
        {
            ...
            gl_Position = projectionMatrix * viewMatrix * modelPosition;
						...
						// color
						float colorElevation = clamp(elevation, 0.25, 1.0);
    ...
    `,
  // try to do calculations in vertex shader and send to fragment using varying, but might lose details
  fragmentShader: `
        // uniform sampler2D uDisplacementTexture;
